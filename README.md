...
1. [github.com](https://github.com) → Hesap oluştur
2. Email doğrula

### Adım 2: Repository Oluştur
1. **New repository** → `2days`
2. **Public** seç
3. **Create repository**
...
3. **Save**
4. 2-3 dakika bekle
5. **Link**: `https://kullaniciadi.github.io/2days`
...
## 📱 Android Uygulaması (İsteğe Bağlı)

### PWA → Android (Kolay Yol)
1. **Bubblewrap** indir: [bubblewrap.dev](https://github.com/GoogleChromeLabs/bubblewrap)
2. Terminal:
```bash
npx @bubblewrap/cli init --manifest https://kullaniciadi.github.io/2days/manifest.json
npx @bubblewrap/cli build
```
3. `.apk` dosyası oluşur
4. Play Store'a yüklenebilir
...
**Özellikler:**
- Tüm günleri düzenleme
- Günleri sıfırlama
- Debug logları
- Gelecek günleri test

**Nasıl Kullanılır:**
1. **Hakkında** → **Test Modu**
2. Şifreyi gir
3. **Aktifleştir**
